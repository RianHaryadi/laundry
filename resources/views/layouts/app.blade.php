    ...
    <nav class="bg-white/95 backdrop-blur-md shadow-sm fixed top-0 left-0 right-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="{{ route('home') }}" class="nav-link text-gray-700 hover:text-blue-600 font-medium {{ request()->routeIs('home') ? 'active text-blue-600' : '' }}">
                        Home
                    </a>
                    <a href="#services" class="nav-link text-gray-700 hover:text-blue-600 font-medium">
                        Services
                    </a>
                    <a href="{{ route('tracking') }}" class="nav-link text-gray-700 hover:text-blue-600 font-medium {{ request()->routeIs('tracking') ? 'active text-blue-600' : '' }}">
                        Tracking
                    </a>
                    <a href="{{ route('booking') }}" class="nav-link text-gray-700 hover:text-blue-600 font-medium {{ request()->routeIs('booking') ? 'active text-blue-600' : '' }}">
                        Booking
                    </a>
                ...
                <div class="hidden md:flex items-center space-x-3">
                    @auth
                        <a href="#" class="btn-primary px-5 py-2 rounded-lg font-medium text-white">
                            Schedule Pickup
                        </a>
                        <div class="relative group">
                            ...
                            <div class="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                                ...
                                <a href="{{ route('profile') }}" class="flex items-center px-4 py-2.5 hover:bg-gray-50 text-gray-700 transition">
        ...
        <div id="mobile-menu" class="mobile-menu md:hidden bg-white border-t border-gray-100">
            <div class="px-4 py-4 space-y-1">
                <a href="{{ route('home') }}" class="block px-4 py-3 rounded-lg hover:bg-blue-50 text-gray-700 hover:text-blue-600 font-medium {{ request()->routeIs('home') ? 'bg-blue-50 text-blue-600' : '' }}">
                    Home
                </a>
                <a href="#services" class="block px-4 py-3 rounded-lg hover:bg-blue-50 text-gray-700 hover:text-blue-600 font-medium">
                    Services
                </a>
                <a href="{{ route('tracking') }}" class="block px-4 py-3 rounded-lg hover:bg-blue-50 text-gray-700 hover:text-blue-600 font-medium {{ request()->routeIs('tracking') ? 'bg-blue-50 text-blue-600' : '' }}">
                    Tracking
                </a>
                <a href="{{ route('booking') }}" class="block px-4 py-3 rounded-lg hover:bg-blue-50 text-gray-700 hover:text-blue-600 font-medium {{ request()->routeIs('booking') ? 'bg-blue-50 text-blue-600' : '' }}">
                    Booking
                </a>
                ...
                @auth
                    <div class="pt-4 border-t border-gray-200 space-y-1">
                        <a href="#" class="block btn-primary py-3 rounded-lg font-medium text-white text-center mb-3">
                            Schedule Pickup
                        </a>
                        ...
                        <a href="{{ route('profile') }}" class="block px-4 py-3 rounded-lg hover:bg-gray-50 text-gray-700">
                            My Profile
                        </a>
